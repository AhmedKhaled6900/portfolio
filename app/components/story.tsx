    ...
    return (
        <Container>
            <div className="flex flex-col justify-center items-center  ">
                ...
                <div
                    data-aos="zoom-in"
                    className=" grid grid-cols-1 md:grid-cols-2 gap-5 my-10 p-5  rounded-xl bg-gradient-to-r text-sm  shadow-xl shadow-sky-900 "
                >
                    <div className="flex flex-col justify-center items-center  ">
                        <div>
                            <div className=" border-b-[.1px] border-b-sky-500 my-4 ">
                                <p className="p-2 text-white  ">
                                    Front-End Developer with 3 years of experience in learning and
                                    mastering front-end basics and new technologies to achieve
                                    building responsive and dynamic web apps. That leads me to be
                            ...
                            <div className=" border-b-[.1px] border-b-sky-500 my-4 ">
                                <p className="p-2 text-white ">
                                    ...
                                    learning the latest front-end technologies. I can work all the
                                    time without any boredom and never stop searching and learning
                                    I am proficient in using the power of AI to help learning and
                                    also completing my tasks faster and with very high accuracy.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    {steps.map((step) => (
                        <div
                           data-aos-delay={step.delay}
                            data-aos="fade-down"
                            className="flex flex-col text-white text-center bg-gradient-to-r rounded-lg items-center "
                        >
                            <Image src={step.icon} alt="" />
                            <p className="font-bold text-2xl  ">{step.head}</p>
                            <p className="p-2">{step.text}</p>
                        </div>
                    ))}
                </div>
            </div>
